...
curl -o %CD%\paper.jar https://papermc.io/api/v1/paper/1.16.1/92/download
curl -o  %CD%\plugins\fastasynworldedit.jar https://ci.athion.net/job/FastAsyncWorldEdit-1.16/lastSuccessfulBuild/artifact/worldedit-bukkit/build/libs/FastAsyncWorldEdit-1.16-297.jar
